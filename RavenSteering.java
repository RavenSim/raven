...
public class RavenSteering {
	...
	/* Detects obstacles in the path of the bot,
	 * uses the feelers to avoid the obstacles
	 */
	private Vector2D obstAvoidance(final ArrayList<Vector2D> obst) {
		//the feelers are contained in a std::vector, m_Feelers
		createFeelers();
